...
+ (instancetype)makeWithPermanentSecretId:(nullable NSString *)permanentSecretId
    permanentSecretKey:(nullable NSString *)permanentSecretKey
    ...
    bucketInPath:(nullable NSNumber *)bucketInPath
  ...
  pigeonResult.permanentSecretId = permanentSecretId;
  pigeonResult.permanentSecretKey = permanentSecretKey;
  ...
  pigeonResult.bucketInPath = bucketInPath;
...
+ (CosXmlServiceConfig *)fromMap:(NSDictionary *)dict {
  CosXmlServiceConfig *pigeonResult = [[CosXmlServiceConfig alloc] init];
  pigeonResult.permanentSecretId = GetNullableObject(dict, @"permanentSecretId");
  pigeonResult.permanentSecretKey = GetNullableObject(dict, @"permanentSecretKey");
  ...
  pigeonResult.bucketInPath = GetNullableObject(dict, @"bucketInPath");
...
- (NSDictionary *)toMap {
  return @{
    @"permanentSecretId" : (self.permanentSecretId ?: [NSNull null]),
    @"permanentSecretKey" : (self.permanentSecretKey ?: [NSNull null]),
    ...
    @"bucketInPath" : (self.bucketInPath ?: [NSNull null]),
  ...
  }
  {
    ...
    if (api) {
      ...
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        ...
        [api preBuildConnectionBucket:arg_bucket serviceKey:arg_serviceKey completion:^(NSNumber *_Nullable output, FlutterError *_Nullable error) {
          callback(wrapResult(output, error));
        }];
      }];
    }
