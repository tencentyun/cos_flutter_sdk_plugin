...
@property(nonatomic, copy, nullable) NSString * permanentSecretId;
@property(nonatomic, copy, nullable) NSString * permanentSecretKey;
...
@property(nonatomic, strong, nullable) NSNumber * bucketInPath;
...
- (void)preBuildConnectionBucket:(NSString *)bucket serviceKey:(NSString *)serviceKey completion:(void(^)(NSNumber *_Nullable, FlutterError *_Nullable))completion;
