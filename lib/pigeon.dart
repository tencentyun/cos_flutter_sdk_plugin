...
class CosXmlServiceConfig {
  CosXmlServiceConfig({
    this.permanentSecretId,
    this.permanentSecretKey,
    this.region,
  ...
  Object encode() {
    ...
    pigeonMap['permanentSecretId'] = permanentSecretId;
    pigeonMap['permanentSecretKey'] = permanentSecretKey;
    ...
    pigeonMap['bucketInPath'] = bucketInPath;
  ...
  static CosXmlServiceConfig decode(Object message) {
    ...
    return CosXmlServiceConfig(
      permanentSecretId: pigeonMap['permanentSecretId'] as String?,
      permanentSecretKey: pigeonMap['permanentSecretKey'] as String?,
      ...
      bucketInPath: pigeonMap['bucketInPath'] as bool?,
...
class CosServiceApi {
  ...
  Future<bool> preBuildConnection(String arg_bucket, String arg_serviceKey) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
