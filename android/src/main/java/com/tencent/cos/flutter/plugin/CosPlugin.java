...
public class CosPlugin implements FlutterPlugin, Pigeon.CosApi, Pigeon.CosServiceApi, Pigeon.CosTransferApi {
    ...
    public void registerDefaultService(@NonNull Pigeon.CosXmlServiceConfig config) {
        cosServices.put(DEFAULT_KEY, buildCosXmlService(context, config));
    }
    ...
    public void registerDefaultTransferManger(@NonNull Pigeon.CosXmlServiceConfig config, @Nullable Pigeon.TransferConfig transferConfig) {
        transferManagers.put(DEFAULT_KEY, buildTransferManager(context, config, transferConfig));
    }
    ...
    public void registerService(@NonNull String key, @NonNull Pigeon.CosXmlServiceConfig config) {
        ...
        cosServices.put(key, buildCosXmlService(context, config));
    }
    ...
    public void registerTransferManger(@NonNull String key, @NonNull Pigeon.CosXmlServiceConfig config, @Nullable Pigeon.TransferConfig transferConfig) {
        ...
        transferManagers.put(key, buildTransferManager(context, config, transferConfig));
    }
    ...
    @Override
    public void preBuildConnection(@NonNull String bucket, @NonNull String serviceKey, Pigeon.Result<Boolean> result) {
        CosXmlService service = getCosXmlService(serviceKey);
    ...
    private CosXmlService buildCosXmlService(Context context, @NonNull Pigeon.CosXmlServiceConfig config) {
        ...
        if (config.getBucketInPath() != null) {
            serviceConfigBuilder.setBucketInPath(config.getBucketInPath());
        }
        ...
        return new CosXmlService(context,
                serviceConfigBuilder.builder(), getQCloudCredentialProvider(config.getPermanentSecretId(), config.getPermanentSecretKey()));
    }

    private QCloudCredentialProvider getQCloudCredentialProvider(String permanentSecretId, String permanentSecretKey) {
        if (!TextUtils.isEmpty(permanentSecretId) && !TextUtils.isEmpty(permanentSecretKey)) {
            Log.d(TAG, "getQCloudCredentialProvider=ShortTimeCredentialProvider");
            ...
            Log.d(TAG, "getQCloudCredentialProvider=BasicLifecycleCredentialProvider");
